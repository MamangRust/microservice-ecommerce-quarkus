...
public class UserServiceImpl implements UserService {
    ...
    public Uni<UserDto.ApiResponsePaginationUserDeleteAt> getActiveUsers(int page, int size, String search) {
        return telemetryHelper.traceAndMetric("user.getActiveUsers", () -> userQueryService.findByActive(pb.user.UserQuery.FindAllUserRequest.newBuilder()
                .setPage(page)
                .setPageSize(size)
                .setSearch(search == null ? "" : search)
                .build())
    ...
    public Uni<UserDto.ApiResponsePaginationUserDeleteAt> getTrashedUsers(int page, int size, String search) {
        return telemetryHelper.traceAndMetric("user.getTrashedUsers", () -> userQueryService.findByTrashed(pb.user.UserQuery.FindAllUserRequest.newBuilder()
                .setPage(page)
                .setPageSize(size)
                .setSearch(search == null ? "" : search)
                .build())
